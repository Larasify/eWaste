...
export default function Device() {
  return (
    <div className="mt-8 mx-24 flex justify-center h-full flex-col">
      <div className="mt-4 ml-4 flex flex-row border-b-2 border-b-[#509E82]">
        <div className="flex w-8 h-8 rounded-3xl bg-[#509E82] text-[#ffffff] text-xl justify-center items-center cursor-pointer"><a href='/'><IoIosArrowBack/></a></div>
        <div className="ml-8 flex text-[#509E82] flex-col pb-4">
      ...
      <div className="mx-20 my-4 flex flex-row justify-center">
        <div className="flex flex-col justify-center items-center w-1/3 text-4xl text-[#509E82] font-semibold">
          <span>Details</span>
        ...
        <div className="mt-4 w-2/3 flex flex-col">
          ...
          <div className="flex mt-8">
            ...
            <label className='mr-12 ml-2 font-bold' for="wiping">Wipe Data from Device</label>
            <input type="radio" id="retrieval" name="service" value="retrieval"/>
            <label className='mr-12 ml-2 font-bold' for="retrieval">Wipe & Retrieve Data from Device</label>
          </div>
        </div>
      </div>
