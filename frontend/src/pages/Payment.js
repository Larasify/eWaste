...
export default function Payment(){
    ...
    return(
        ...
        <div className={"flex flex-col w-full md:w-5/6 md:mx-auto h-full md:h-5/6 bg-[#ECF4F1] md:rounded-3xl md:mt-12"} >
                    ...
                    <div className={"inline mt-6 space-x-6 flex flex-row px-4" }  >
                        <span className={"font-semibold text-2xl pr-8 md:text-4xl"}>Payments:</span>
                            <div className="flex items-center md:gap-x-10">
                                ...
                                <label for="flexRadioPaypal" className='block leading-6'><BsPaypal size={40}/></label>
                            </div>
                            <div className={"flex items-center md:gap-x-10 "}>
                                <input className="h-6 w-6 border-gray-300 focus:ring-indigo-600" type="radio" name="flexRadio" id="flexRadioStripe"></input>
                                <label for="flexRadioStripe" className='block leading-6'><FaCcStripe size={40}/></label>
            ...
            <button className={"flex justify-center items-center px-4 md:px-2 py-3 text-3xl font-medium mt-16 mb-20 bg-[#509E82] text-xl rounded-2xl md:text-2xl md:rounded-full w-1/5 mx-auto text-white font-medium md:font-bold hover:bg-[#4E8E77] "} onClick={paySuc}>Pay</button>
